...
--Ejercicio 1:
create or replace function facturacion(p_tf_origen mf.llamada.tf_origen%type, p_año integer)return float is  --Esto seria para ejecutar una funcion y visualizarla siempre tiene que llevar el return float is para que devuelva algo
  importe number(10, 2);
